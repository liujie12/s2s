...
class AuthRefreshInterceptor extends Interceptor {
  ...
  // 重放调度标记 authReplayDispatchExtraKey 及错误形态剥离函数
  // errorWithoutExtraKey 为 AuthRefresh/Retry 两拦截器共享实现，定义见
  // dispatch_markers.dart（复审 #1，编码规范 §1.1 禁止各抄一份）。
  ...
  Future<void> _replay(
    ...
    try {
      ...
      handler.reject(
        errorWithoutExtraKey(replayError, authReplayDispatchExtraKey),
        true,
      );
    }
  }
